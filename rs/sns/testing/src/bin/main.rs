...
use ic_sns_testing::utils::{
    get_nns_neuron_controller, get_nns_neuron_hotkeys, validate_network as validate_network_impl,
...
async fn run_basic_scenario(network: String, args: RunBasicScenarioArgs) {
    ...
    // Check if provide identity is allowed to create proposals on behalf of the neuron.
